    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            padding: 10px;
            margin: 10px;
            width: 100%; /* Alterado para largura total na tela pequena */
            cursor: pointer;
        }
    ...
    <div class="container">
            ...
            <form method="post" action="{{ route('agendamento.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="cliente-imagem">Data do Agendamento : {{ $data['sabado'] }}</label>
                ...
                <div class="form-group">
                    <label for="data-evento">Phone</label>
                    <input type="text" id="number" name="number" value="{{ $data['phone'] }}" data-inputmask="'mask': ['+55 (99) 99999-9999']">
                </div>
